...
class ProfilEditPimpinanActivity : AppCompatActivity() {
    ...
    private fun showProfil(mode: String) {
        val request = object : StringRequest(
            ...
            Response.Listener { response ->
                ...
                if (unitKerja.equals("Panitera")) {
                    edtUnitKerjaUser.setText("Kepaniteraan")
                    unitK = unitKerja
                } else if (unitKerja.equals("Sekretaris")) {
                    edtUnitKerjaUser.setText("Kesekretariatan")
                    unitK = unitKerja
                } else {
                    edtUnitKerjaUser.setText("Ketua/Wakil")
                    unitK = unitKerja
                }
