...
class RiwayatPimpinanActivity : AppCompatActivity() {
...
//        val btnIcon = v.findViewById<Button>(R.id.btnHapusIcon)
//        val btnHapus = v.findViewById<Button>(R.id.btnHapusCuti)
//        val card_hapus = v.findViewById<CardView>(R.id.cardHapus)
        }
        ...
        override fun onBindViewHolder(holder: HolderDataCuti, position: Int) {
            ...
            holder.card.setOnClickListener { v: View ->
                val intentDetail = Intent(v.context, RiwayatDetailPimpinanActivity::class.java)
