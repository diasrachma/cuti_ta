...
import com.example.cuti_ta.pimpinan.IzinDetailPimpinanActivity
import kotlinx.android.synthetic.main.activity_izin_riwayat.*
import org.json.JSONArray

class IzinRiwayatPegawaiActivity : AppCompatActivity() {
    ...
    class AdapterIzin(val dataIzin : List<HashMap<String,String>>)
        ...
        override fun onBindViewHolder(holder: HolderDataIzin, position: Int) {
            ...
            if(position.rem(2)==0) holder.card.setCardBackgroundColor(Color.parseColor("#E5E5CB"))
            else holder.card.setCardBackgroundColor(Color.parseColor("#D8D8D8"))
            ...
            holder.card.setOnClickListener {
                val intent = Intent(it.context, IzinDetailPegawaiActivity::class.java)
